...
SWIFT_CLASS("_TtC9UDPClient11AppDelegate")
...
SWIFT_CLASS("_TtC9UDPClient14ViewController")
@interface ViewController : UIViewController <GCDAsyncUdpSocketDelegate, UITextFieldDelegate>
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified hostTextField;
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified localPortTextField;
...
- (IBAction)sendPacket:(id __nonnull)sender;
- (void)udpSocket:(GCDAsyncUdpSocket * __null_unspecified)sock didReceiveData:(NSData * __null_unspecified)data fromAddress:(NSData * __null_unspecified)address withFilterContext:(id __null_unspecified)filterContext;

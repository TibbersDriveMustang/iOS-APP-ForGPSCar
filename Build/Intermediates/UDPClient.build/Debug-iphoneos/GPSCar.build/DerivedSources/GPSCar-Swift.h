...
SWIFT_CLASS("_TtC6GPSCar11AppDelegate")
...
SWIFT_CLASS("_TtC6GPSCar14ViewController")
@interface ViewController : UIViewController <GCDAsyncUdpSocketDelegate, MKMapViewDelegate, CLLocationManagerDelegate, UITextFieldDelegate>
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified hostTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified localPortTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified remotePortTextField;
...
@property (nonatomic, strong) MKPointAnnotation * _Nonnull carAnnotation;
